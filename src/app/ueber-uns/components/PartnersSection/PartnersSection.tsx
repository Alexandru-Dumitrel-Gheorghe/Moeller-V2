  ...
  return (
    <>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.ctaWrapper}>
            <div className={styles.ctaContent}>
              ...
              {/* Button care deschide modalul */}
              <button
                type="button"
                className={styles.ctaButton}
                onClick={() => setIsModalOpen(true)}
                aria-haspopup="dialog"
                aria-controls="partners-modal"
              >
      ...
      <Modal
        ...
        description="Sprechen Sie mit uns über Marken, Geräte und Materialien – wir beraten Sie unabhängig und individuell."
      />
    </>
  );
}
