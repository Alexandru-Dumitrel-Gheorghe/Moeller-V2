          ...
          <div className={styles.panelInner}>
            ...
            <div className={styles.content}>
              <p className={styles.paragraph}>
                ...
                <strong>Möller Küchen</strong>
                anspruchsvolle Projekte auf höchstem Niveau. Dabei ist die Küche
                zwar das Herzstück des Zuhauses, doch wird sie als Gesamtkonzept
                mit dem dazu passenden Wohn- und Essbereich sowie intelligenten
              ...
              <p className={styles.paragraph}>
                ...
                Präzision umsetzen. So entstehen ganzheitliche Raumkonzepte aus
                einer Hand, die zu einem harmonischen Ganzen verschmelzen.
              </p>
            </div>
